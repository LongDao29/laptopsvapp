    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        addtocart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (user_id.equals("-1")) {
                    Toast.makeText(root.getContext(),"Bạn phải đăng nhập để mua hàng",Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    if (checkexistproduct == true) {
                       ...
                       progressDialog= ProgressDialog.show(root.getContext(),"Đang thêm vào giỏ hàng","Vui lòng chờ...",false,false);
                        try {
                            Thread.sleep(1000);
