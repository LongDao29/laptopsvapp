...
public class laptopData {
    ...
    public Laptop takeallinfo(String productID, TextView name, TextView price, TextView masp, ImageSlider imageSlider, YouTubePlayerView view, ImageView addtocart) {
        ...
        apiService.detail(productID).enqueue(new Callback<Laptop>() {
            ...
            public void onResponse(Call<Laptop> call, Response<Laptop> response) {
                ...
                List<SlideModel> slideModels = new ArrayList<>();
                    slideModels.add(new SlideModel(laptops.getImg(),null));
                imageSlider.setImageList(slideModels,true);
                String temp_video = laptops.getLink_review().get(0).trim();
                String id_video = temp_video.split("v=")[1];
        ...
        apiService.detail(productID).enqueue(new Callback<Laptop>() {
            ...
            public void onResponse(Call<Laptop> call, Response<Laptop> response) {
                ...
                try {
                    ...
                    URL url = new URL(laptops.getImg().trim());
