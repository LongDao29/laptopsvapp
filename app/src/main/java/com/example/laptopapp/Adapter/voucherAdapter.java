...
public class voucherAdapter extends BaseAdapter {
    ...
    private ArrayList<Voucher> listData;
    private LayoutInflater layoutInflater;
    private Context context;

    public voucherAdapter(Context aContext, ArrayList<Voucher> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Voucher promotion = this.listData.get(position);
        holder.NameView.setText(promotion.getDescription());
        try {
            URL url = new URL(promotion.getImage().trim());
