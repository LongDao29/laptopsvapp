...
public class MainActivity extends AppCompatActivity implements DrawerAdapter.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_icon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentTransaction transaction = getSupportFragmentManager().beginTransaction(); // goi fragment manger
                Bundle bundle = new Bundle();
                bundle.putString("name", tv_searchname.getText().toString());
                frm_product product = new frm_product();
                transaction.replace(R.id.container, product); // chuyen fragment
            ...
            apiService.login(id_token).enqueue(new Callback<Login>() {
                ...
                public void onResponse(Call<Login> call, Response<Login> response) {
                    ...
                    try {
                        ...
                        signOut();
                        System.out.println("loi thoi gian dang nhap"+ e);
